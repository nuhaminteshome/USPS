...
Findings are visualized in the **Power BI dashboard** (`USPS_Service_Performance_Dashboard.pbix`), covering:
- 📦 On-time delivery rates by urban vs. rural ZIP codes
- 📈 Performance trends by mail type and time period
- 🗺️ Geographic distribution of delivery scores
